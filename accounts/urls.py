...
urlpatterns = [
    ...
    path("admin/delete/agent/associate/dahboard/<int:id>/",views.admin_deletes_agents_associates,name="admin.delete.agent.associate.dashboard"),
    ...
    path("agent/dashboard/view/",views.agent_dashboard_view,name='agent.view.dashboard'),
    path("agent/delete/associates/dashboard/<int:id>/",views.agents_deleted_associates,name="agent.deletes.associates.dashboard"),
    ...
    path("associate/index/tracking/dashboard/",views.associate_tracking_updates,name="associate.index.tracking.dashboard"),

    path("agent/view/dashboard/",views.agent_view_task,name="agent.view_task.dashboard"),

    path("agent/assign/task/dashboard/<str:name>/",views.agent_assign_task,name="agent.assign_lead.dashboard"),
    ...
    path('admin/lead_details/dashboard/',views.lead_details,name="admin.lead_details.dashboard"),
    path('admin/delete_lead/dashboard/<int:id>/',views.delete_lead_admin,name="admin.delete.lead.dashboard"),
]
